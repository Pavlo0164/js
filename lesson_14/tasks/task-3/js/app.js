...
let availProduct = dataList.filter((item) => item.sell_status === "available");
...
let updateProduct = availProduct.map((item) => {
	return { id: item.id, price: item.price, old_price: item.old_price, usd_price: item.usd_price };
});
